...
public class PostTest {
    ...
    public void updateDescription() {
        ...
        //when
        post.update(post.getTitle(), "수정 후 설명글", post.getMaximum(), post.getPostStatus());
    ...
    public void updateTitle() {
        ...
        //when
        post.update("수정 후 제목", post.getDescription(), post.getMaximum(), post.getPostStatus());
    ...
    public void updateStatus() {
        ...
        //when
        post.update(post.getTitle(), post.getDescription(), post.getMaximum(), PostStatus.DONE);
    ...
    public void updateMaximum() {
        ...
        //when
        post.update(post.getTitle(), post.getDescription(), 2, post.getPostStatus());
